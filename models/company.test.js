...
describe('findAll', function() {
	...
	test('works: with both min and max filter', async function() {
		let companies = await Company.findAll({ maxEmployees: 2, minEmployees: 2 });
		expect(companies).toEqual([
			{
				handle: 'c2',
				name: 'C2',
	...
	test('works: with name and min and max', async function() {
		let companies = await Company.findAll({ name: 'c2', minEmployees: 2, maxEmployees: 2 });
		console.log(companies);
		expect(companies).toEqual([
			{
				handle: 'c2',
...
describe('get', function() {
	test('works', async function() {
		let company = await Company.get('c1', 'c');
